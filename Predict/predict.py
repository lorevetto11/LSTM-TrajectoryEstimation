...
class Predict:
    ...
    def test_predict_trajectory_OneArray(self):
        ...
        model = load_model('Model/LSTM/Saved/NowBest.h5')
        #model = load_model('Model/LSTM/Saved/Bidirectional/OneLayer.h5')

        for document in glob.glob('Predict/Segmentation/*.csv'):
