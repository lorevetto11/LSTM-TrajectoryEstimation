...
class LSTM_Model:
    ...
    def __init__(self):
        ...
        self.dataset_files, self.dataset_files_tra = [], []
    ...
    def train_model_bidirectional_lstm_one_layer(self, X, Y):
        ...
        plt.show()
        '''
        self.model.save('Model/LSTM/Saved/Bidirectional/OneLayer.h5')

    def train_model_bidirectional_lstm_multi_layer(self, X, Y):
        self.model.add(layers.Bidirectional(layers.LSTM(64, activation='relu'), input_shape=(1, 4), return_sequences=True))
    ...
    def train_model_cnn_lstm_one_layer(self, X, Y):
        ...
        self.model.add(layers.LSTM(50, activation='relu', input_shape=(1, 4)))
        self.model.add(layers.Dense(2))
        self.model.compile(optimizer='adam', loss='mse')
